...
public class TimKiemBienBaoActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{

    private ImageView imgReturn;
    private ListView lv_timKiemBienbao;
    private ArrayList<BienBao> bienBaos;
    BienBaoAdapter bienBaoAdapter;

    private SearchView searchViewBienbao;
    private LinearLayout ll_timkiembienbao;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tim_kiem_bien_bao);

        ll_timkiembienbao = findViewById(R.id.ll_timkiembienbao);
        Intent i3 = getIntent();
        int value = i3.getIntExtra("KEY1",getResources().getColor(R.color.xanh1));
        ll_timkiembienbao.setBackgroundColor(value);

        imgReturn = findViewById(R.id.imgReturn);
        imgReturn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ColorDrawable colorDrawable =(ColorDrawable) ll_timkiembienbao.getBackground();
                int manau2 = colorDrawable.getColor();
                Intent i5 = new Intent(TimKiemBienBaoActivity.this,MenuTimKiemActivity.class);
        ...
        lv_timKiemBienbao = findViewById(R.id.lv_timKiemBienbao);
        ...
        lv_timKiemBienbao.setAdapter(bienBaoAdapter);

        searchViewBienbao = findViewById(R.id.searchBienbao);
        searchViewBienbao.setOnQueryTextListener(this);
    ...
    public boolean onQueryTextChange(String newText) {
        bienBaoAdapter.filer(newText.trim());
        return false;
    }
}
